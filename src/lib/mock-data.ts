...
export const mockProject: Project = {
    ...
    progressDetails: {
        kyc: {
            ...
            checklist: [
                { id: 'kyc-1', label: 'Formulir KYC diisi oleh semua anggota', completed: true, completedBy: 'user-001', completedAt: '2025-01-15T10:00:00Z' },
                { id: 'kyc-2', label: 'Upload KTP/SIM semua anggota', completed: true, completedBy: 'user-002', completedAt: '2025-01-15T11:30:00Z' },
                { id: 'kyc-3', label: 'Upload NPWP semua anggota', completed: true, completedBy: 'user-001', completedAt: '2025-01-16T09:15:00Z' },
                { id: 'kyc-4', label: 'Verifikasi dokumen oleh tim legal', completed: true, completedBy: 'user-001', completedAt: '2025-01-20T17:00:00Z' },
            ],
            completedMembers: ['user-001', 'user-002', 'user-003', 'user-004'],
            milestones: [
                { label: 'Mulai Verifikasi', date: '2025-01-15T08:00:00Z', status: 'completed' },
                { label: 'Dokumen Lengkap', date: '2025-01-16T12:00:00Z', status: 'completed' },
                { label: 'Verifikasi Selesai', date: '2025-01-20T17:00:00Z', status: 'completed' },
            ],
        ...
        funding: {
            ...
            checklist: [
                { id: 'fund-1', label: 'Pembayaran DP dari user-001 (Rp 60.000.000)', completed: true, completedBy: 'user-001', completedAt: '2025-01-18T14:00:00Z' },
                { id: 'fund-2', label: 'Pembayaran DP dari user-002 (Rp 62.400.000)', completed: true, completedBy: 'user-002', completedAt: '2025-01-18T15:30:00Z' },
                { id: 'fund-3', label: 'Pembayaran DP dari user-003 (Rp 60.000.000)', completed: true, completedBy: 'user-003', completedAt: '2025-01-20T10:00:00Z' },
                { id: 'fund-4', label: 'Pembayaran DP dari user-004 (Rp 64.800.000)', completed: true, completedBy: 'user-004', completedAt: '2025-01-19T10:00:00Z' },
                { id: 'fund-5', label: 'Pembayaran pelunasan dari semua anggota', completed: true, completedBy: 'user-001', completedAt: '2025-02-05T14:00:00Z' },
            ],
            completedMembers: ['user-001', 'user-002', 'user-003', 'user-004'],
            milestones: [
                { label: 'Target DP 30%', date: '2025-01-20T23:59:59Z', status: 'completed' },
                { label: 'Target DP 60%', date: '2025-01-25T23:59:59Z', status: 'completed' },
                { label: 'Pembayaran Lunas', date: '2025-02-05T23:59:59Z', status: 'completed' },
            ],
        ...
        legal: {
            ...
            checklist: [
                { id: 'legal-1', label: 'Perjanjian Kepemilikan Bersama ditandatangani', completed: true, completedBy: 'user-001', completedAt: '2025-01-22T14:00:00Z' },
                { id: 'legal-2', label: 'Sertifikat Hak Milik diverifikasi', completed: true, completedBy: 'user-001', completedAt: '2025-01-10T09:00:00Z' },
                { id: 'legal-3', label: 'Akta Jual Beli disiapkan', completed: true, completedBy: 'user-001', completedAt: '2025-01-30T17:00:00Z' },
                { id: 'legal-4', label: 'Pembagian unit ditetapkan secara legal', completed: true, completedBy: 'user-001', completedAt: '2025-02-01T10:00:00Z' },
            ],
            completedMembers: ['user-001', 'user-002', 'user-003', 'user-004'],
            milestones: [
                { label: 'Verifikasi Sertifikat', date: '2025-01-10T09:00:00Z', status: 'completed' },
                { label: 'Penandatanganan Perjanjian', date: '2025-01-22T14:00:00Z', status: 'completed' },
                { label: 'Akta Jual Beli Selesai', date: '2025-01-30T17:00:00Z', status: 'completed' },
            ],
        ...
        closing: {
            ...
            checklist: [
                { id: 'close-1', label: 'Semua pembayaran lunas', completed: true, completedBy: 'user-001', completedAt: '2025-02-05T14:00:00Z' },
                { id: 'close-2', label: 'Dokumen legal lengkap', completed: true, completedBy: 'user-001', completedAt: '2025-02-01T10:00:00Z' },
                { id: 'close-3', label: 'Sertifikat dibagi sesuai unit', completed: true, completedBy: 'user-001', completedAt: '2025-02-10T14:00:00Z' },
                { id: 'close-4', label: 'Serah terima properti', completed: true, completedBy: 'user-001', completedAt: '2025-02-15T10:00:00Z' },
            ],
            completedMembers: ['user-001', 'user-002', 'user-003', 'user-004'],
            milestones: [
                { label: 'Pembayaran Lunas', date: '2025-02-05T23:59:59Z', status: 'completed' },
                { label: 'Penutupan Transaksi', date: '2025-02-10T14:00:00Z', status: 'completed' },
                { label: 'Serah Terima', date: '2025-02-15T10:00:00Z', status: 'completed' },
            ],
    ...
    documents: [
        ...
        },
        {
            ...
            uploadedBy: 'user-001',
            signedBy: ['user-001', 'user-002', 'user-003', 'user-004'],
            verifiedAt: '2025-01-20T17:00:00Z',
        },
    ],
    messages: [
            ...
            payments: [
                {
                    ...
                    unitId: 1,
                    amount: 5000000,
                    paymentDate: '2025-03-05T10:00:00Z',
                ...
                },
                {
                    ...
                    unitId: 1,
                    amount: 5000000,
                    paymentDate: '2025-04-03T14:30:00Z',
                    dueDate: '2025-04-01T00:00:00Z',
                    period: '2025-04',
                    status: 'paid',
                    paymentMethod: 'transfer',
                    receiptUrl: '/receipts/pay-002.pdf',
                    verifiedAt: '2025-04-03T15:00:00Z',
                ...
                },
                {
                    ...
                    verifiedAt: '2025-05-02T10:00:00Z',
            ...
            payments: [
                {
                    ...
                    unitId: 3,
                    amount: 5200000,
                    paymentDate: '2025-03-04T11:20:00Z',
                    dueDate: '2025-03-01T00:00:00Z',
                    period: '2025-03',
                    status: 'paid',
                    paymentMethod: 'transfer',
                    receiptUrl: '/receipts/pay-005.pdf',
                    verifiedAt: '2025-03-04T12:00:00Z',
                ...
                },
                {
                    ...
                    unitId: 3,
                    amount: 5200000,
                    paymentDate: '2025-04-02T16:45:00Z',
                    dueDate: '2025-04-01T00:00:00Z',
                    period: '2025-04',
                    status: 'paid',
                    paymentMethod: 'transfer',
                    receiptUrl: '/receipts/pay-006.pdf',
                    verifiedAt: '2025-04-02T17:00:00Z',
            ...
            payments: [
                {
                    ...
                    unitId: 5,
                    amount: 5400000,
                    paymentDate: '2025-03-06T13:10:00Z',
                    dueDate: '2025-03-01T00:00:00Z',
                    period: '2025-03',
                    status: 'paid',
                    paymentMethod: 'transfer',
                    receiptUrl: '/receipts/pay-009.pdf',
                    verifiedAt: '2025-03-06T14:00:00Z',
                ...
                },
                {
                    ...
                    unitId: 5,
                    amount: 5400000,
                    paymentDate: '2025-04-01T10:00:00Z',
                    dueDate: '2025-04-01T00:00:00Z',
                    period: '2025-04',
                    status: 'paid',
                    paymentMethod: 'transfer',
                    receiptUrl: '/receipts/pay-010.pdf',
                    verifiedAt: '2025-04-01T11:00:00Z',
                ...
                },
                {
                    ...
                    unitId: 5,
                    amount: 5400000,
                    paymentDate: '2025-05-01T09:00:00Z',
                    dueDate: '2025-05-01T00:00:00Z',
                    period: '2025-05',
                    status: 'paid',
                    paymentMethod: 'transfer',
                    receiptUrl: '/receipts/pay-011.pdf',
                    verifiedAt: '2025-05-01T10:00:00Z',
...
const proj002: Project = {
    ...
    progressDetails: {
        kyc: {
            ...
            description: 'Proses verifikasi identitas dan dokumen KYC untuk semua anggota grup.',
            checklist: [
                { id: 'kyc-1', label: 'Formulir KYC diisi oleh semua anggota', completed: true, completedBy: 'user-002', completedAt: '2025-03-10T10:00:00Z' },
                { id: 'kyc-2', label: 'Upload KTP/SIM semua anggota', completed: true, completedBy: 'user-002', completedAt: '2025-03-10T11:30:00Z' },
                { id: 'kyc-3', label: 'Upload NPWP semua anggota', completed: true, completedBy: 'user-005', completedAt: '2025-03-11T09:15:00Z' },
                { id: 'kyc-4', label: 'Verifikasi dokumen oleh tim legal', completed: true, completedBy: 'user-002', completedAt: '2025-03-12T14:00:00Z' },
            ],
            completedMembers: ['user-002', 'user-005', 'user-006'],
            milestones: [
                { label: 'Mulai Verifikasi', date: '2025-03-10T08:00:00Z', status: 'completed' },
                { label: 'Dokumen Lengkap', date: '2025-03-11T12:00:00Z', status: 'completed' },
                { label: 'Verifikasi Selesai', date: '2025-03-12T14:00:00Z', status: 'completed' },
            ],
            notes: 'Semua dokumen KYC telah diverifikasi dan disetujui.',
        },
        funding: {
            ...
            description: 'Pengumpulan dana dari semua anggota untuk pembelian properti.',
            checklist: [
                { id: 'fund-1', label: 'Pembayaran DP dari user-002 (Rp 150.000.000)', completed: true, completedBy: 'user-002', completedAt: '2025-03-15T14:00:00Z' },
                { id: 'fund-2', label: 'Pembayaran DP dari user-005 (Rp 150.000.000)', completed: true, completedBy: 'user-005', completedAt: '2025-03-16T10:00:00Z' },
                { id: 'fund-3', label: 'Pembayaran DP dari user-006 (Rp 150.000.000)', completed: true, completedBy: 'user-006', completedAt: '2025-03-17T11:00:00Z' },
                { id: 'fund-4', label: 'Pembayaran tahap 2 dari user-002 (Rp 100.000.000)', completed: false },
            ],
            completedMembers: ['user-002', 'user-005', 'user-006'],
            milestones: [
                { label: 'Target DP 30%', date: '2025-03-20T23:59:59Z', status: 'completed' },
                { label: 'Target DP 60%', date: '2025-03-25T23:59:59Z', status: 'pending' },
                { label: 'Pembayaran Lunas', date: '2025-04-10T23:59:59Z', status: 'upcoming' },
            ],
        ...
        legal: {
            ...
            checklist: [
                ...
                { id: 'legal-2', label: 'Sertifikat Hak Milik diverifikasi', completed: true, completedBy: 'user-002', completedAt: '2025-03-18T09:00:00Z' },
                { id: 'legal-3', label: 'Akta Jual Beli disiapkan', completed: true, completedBy: 'user-002', completedAt: '2025-03-20T14:00:00Z' },
                { id: 'legal-4', label: 'Pembagian unit ditetapkan secara legal', completed: false },
            ],
            completedMembers: ['user-002'],
            milestones: [
                { label: 'Verifikasi Sertifikat', date: '2025-03-18T09:00:00Z', status: 'completed' },
                { label: 'Penandatanganan Perjanjian', date: '2025-03-25T14:00:00Z', status: 'pending' },
                { label: 'Akta Jual Beli Selesai', date: '2025-04-05T17:00:00Z', status: 'upcoming' },
            ],
        ...
        closing: {
            ...
            milestones: [
                { label: 'Pembayaran Lunas', date: '2025-04-10T23:59:59Z', status: 'upcoming' },
                { label: 'Penutupan Transaksi', date: '2025-04-15T14:00:00Z', status: 'upcoming' },
                { label: 'Serah Terima', date: '2025-04-20T10:00:00Z', status: 'upcoming' },
            ],
    ...
    documents: [
        ...
        },
        {
            ...
            status: 'Terverifikasi',
            description: 'Sertifikat SHM asli dari properti yang akan dibeli. Sudah diverifikasi oleh tim legal.',
            uploadDate: '2025-03-15T09:00:00Z',
            size: 512000,
            uploadedBy: 'user-002',
            verifiedAt: '2025-03-18T09:00:00Z',
        },
        {
            id: 'doc-06',
            name: 'Formulir KYC (Semua anggota)',
            ...
            uploadDate: '2025-03-10T08:00:00Z',
            size: 153600,
            uploadedBy: 'user-002',
            signedBy: ['user-002', 'user-005', 'user-006'],
            verifiedAt: '2025-03-12T14:00:00Z',
        },
    ],
    messages: [
...
const proj003: Project = {
    ...
    progressDetails: {
        kyc: {
            ...
            description: 'Proses verifikasi identitas dan dokumen KYC untuk semua anggota grup.',
            checklist: [
                { id: 'kyc-1', label: 'Formulir KYC diisi oleh semua anggota', completed: true, completedBy: 'user-001', completedAt: '2025-04-01T10:00:00Z' },
            ...
            milestones: [
                { label: 'Mulai Verifikasi', date: '2025-04-01T08:00:00Z', status: 'completed' },
                { label: 'Dokumen Lengkap', date: '2025-04-05T12:00:00Z', status: 'pending' },
                { label: 'Verifikasi Selesai', date: '2025-04-10T17:00:00Z', status: 'upcoming' },
            ],
        ...
        funding: {
            ...
            completedMembers: [],
            milestones: [
                { label: 'Target DP 30%', date: '2025-04-15T23:59:59Z', status: 'upcoming' },
                { label: 'Target DP 60%', date: '2025-04-25T23:59:59Z', status: 'upcoming' },
                { label: 'Pembayaran Lunas', date: '2025-05-10T23:59:59Z', status: 'upcoming' },
            ],
        ...
        legal: {
            ...
            completedMembers: [],
            milestones: [
                { label: 'Verifikasi Sertifikat', date: '2025-04-20T09:00:00Z', status: 'upcoming' },
                { label: 'Penandatanganan Perjanjian', date: '2025-04-25T14:00:00Z', status: 'upcoming' },
                { label: 'Akta Jual Beli Selesai', date: '2025-05-05T17:00:00Z', status: 'upcoming' },
            ],
        ...
        closing: {
            ...
            milestones: [
                { label: 'Pembayaran Lunas', date: '2025-05-10T23:59:59Z', status: 'upcoming' },
                { label: 'Penutupan Transaksi', date: '2025-05-15T14:00:00Z', status: 'upcoming' },
                { label: 'Serah Terima', date: '2025-05-20T10:00:00Z', status: 'upcoming' },
            ],
            notes: 'Proses penutupan akan dimulai setelah semua tahap sebelumnya selesai.',
        },
    },
    documents: [
        {
            ...
            status: 'Menunggu',
            description: 'Formulir Know Your Customer yang harus diisi oleh semua anggota grup.',
            uploadDate: '2025-04-01T08:00:00Z',
            size: 153600,
            uploadedBy: 'user-001',
            signedBy: ['user-001'],
        },
