...
export const mockProperties: Property[] = [
  {
    id: 'prop-001',
    name: 'Land for Co-Building in Sidoarjo',
    description: 'A beautiful plot of land perfect for building a multi-story residence for young families, located in a developing area of Sidoarjo.',
    price: 500000000,
  ...
  {
    id: 'prop-002',
    name: 'Apartment Building in Bekasi',
    description: 'An existing apartment building with several floors available for co-living ownership. A great investment in a bustling city.',
    price: 1500000000,
