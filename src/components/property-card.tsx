...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <Link href={`/property/${property.id}`} className="block">
      <Card className="flex flex-col overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.02] group border-2 hover:border-primary/20 cursor-pointer">
